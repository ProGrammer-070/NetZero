...
st.title("🌍 NetZero - Carbon Footprint Tracker")
...
st.markdown("### 🌟 Key Features of NetZero")
...
with st.expander("What is NetZero?", expanded=False):
    st.write("🌎 NetZero is a data-driven web application designed to help individuals track, understand, and reduce their carbon footprint. In today’s world, personal actions play a significant role in addressing climate change. NetZero provides an easy way to quantify the environmental impact of daily activities and encourages users to adopt more sustainable habits.")
...
feedback = st.text_area("Share your thoughts or suggestions here:", placeholder="Share your views...")
