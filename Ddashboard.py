...
def dummyDashboard():
    ...
    # Section Title
    st.markdown("### 🌿 NetZero Dashboard Preview")
    st.write("Here's a sneak peek of the insights you'll gain from tracking your carbon footprint with NetZero.")
    ...
    # Column 2: Projected Reduction with NetZero - Area Chart
    with col2:
    ...
    st.write(
        """
        With NetZero, you'll receive personalized insights like:
